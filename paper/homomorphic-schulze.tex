...
a plaintext $pt$ with $publickey$ (encapsulated inside $group$ with other
parameters 
...
%\begin{mdframed}[] 
%$$
%\infer[\text{\begin{itemize}\item blabla\item kakak\end{itemize}}]{\text{ECount group bs (epartial (us, []) encm)}}{}\
%$$
%\end{mdframed}
