...
The difference between keyword \texttt{Variable} and \texttt{Axiom}
is purely syntactic and used as scoping mechanism.
The keyword \texttt{Variable} indicates the scope of 
function is available in local environment (local variable), while 
keyword \texttt{Axiom} makes it available in global environment
(global variable). 
