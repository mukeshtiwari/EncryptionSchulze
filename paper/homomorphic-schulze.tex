...
is to just count the (encrypted)ballots then we only need 
...
Now we explain the various cryptographic primitives as described above 
...
We achieve the needed functionality described in this step  
by generating permutation, committing permutation,  shuffling ballot, 
and construction of zero knowledge proof as mentioned in second 
