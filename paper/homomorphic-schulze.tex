...
\begin{itemize}
  ...
  ballot privacy,  Schulze's method involving the computation of margin 
  (I am assuming here that margin would 
  already be clear because of previous section) to compute the winners,
   and  ease of  doing computation over encrypted data than linear
