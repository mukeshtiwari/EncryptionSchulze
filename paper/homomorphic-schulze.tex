...
\begin{verbatim}
 ...
 arguments for other cryptographic primitives, i.e. we generate zero knowledge proof 
 for each operation performed during the counting ballots including zero knowledge 
 proofs of secret permutation and the same permutation is used to shuffle the ballot.
 
 Once we are equipped with required cryptographic axioms, we connect the counting of 
 encrypted ballot with plain
