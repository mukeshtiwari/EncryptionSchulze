...
as last step. We achieve this by adding primitives for generating 
permutation, generating commitment of given permutation, 
shuffling a list of ciphertext by given permuation, and constructing 
