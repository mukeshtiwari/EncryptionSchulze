...
\end{itemize}}
 Following from previous section we now give detailed view of formalization.
...
each primitive holds certain properties which are modelled
 ...
 completeness and detail we sketch out one axiom about encryption scheme.
...
\begin{verbatim}
 ...
 Once we have axiomatized cryptographic primitive we use them to construct 
 inhabitant, i.e. outcome of the election, of dependent inductive data type 
 \textbf{ECount} which is index over group, used for cryptographic primitives, 
 list of cast ballots, and another inductive data type 
 \textbf{EState} used to represent different state during counting.
 
 The inductive data type \textbf{EState} whose constructors represent
  different states of counting, and the interpretation of it is,  
  \begin{itemize}
  \item list of uncounted ballots, and invalid ballots seen so far 
  \item computed homomorphic margin so far
  \end{itemize}
  or decrypted margin function, or a boolean function used to determine the winner.
...
As we stated earlier that inhabitant of inductive data \textbf{ECount} represents
the outcome of election, and explain in more detail. 
\begin{itemize}
\item The first constructor, \textbf{ecax}, marks the beginning the counting process by 
 ...
 \item The constructor, \textbf{cvalid}, takes ballot \textbf{u} from pile, ballot 
 ...
 \item The final constructor, \textbf{ecfin}, takes decrypted margin, \textbf{dm}, 
       boolean function, \textbf{w}, and type level function which takes candidate 
       and produces 
