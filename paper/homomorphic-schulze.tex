...
Now that we have permutation pi, we use it permute each row of 
...
function that decides winners \cite{Pattinson:2017:SVE}, 
...
proofs is very simple. It basically hinges on the fact that 
if a ballot (represented as function cand to natural number)  
...
One can think 
of it as regardless of how certificate was produced if the scrutineer, 
auditing the election outcome, can verify 
\begin{itemize}
