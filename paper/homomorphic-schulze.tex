...
\end{itemize}}
Now we describe the details cryptographic primitives, and axioms we assumed 
during the formalization. We came with these primitives while designing our 
protocol(computation) to be verifiable, and maintaining privacy, i.e. votes are 
untraceable, at the same time. The verifiability component is achieved by well known
cryptographic primitives zero knowledge proof, proofs that yield nothing except 
their truthness or falseness, and privacy by encryption.  
