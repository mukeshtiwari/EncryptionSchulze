...
between OCaml and Java we used Jules Aguillon's OCaml-Java library 
(github link: https://github.com/Julow/ocaml-java) which provides
 basic support of mapping OCaml primitive data structure to
 Java primitive data structure, and OCaml class to Java class. 
 ...
 However, subtyping made things complicated for us, because it forced us to 
 write binding for both classes in OCaml, and we ended up writing a
