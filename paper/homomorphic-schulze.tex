...
Coq \cite{Bertot:2004:ITP}. We realize plaintext ballot, and ciphertext ballot, 
the primitive
building block of our formalization, as function, with definition of validity, and
proof that we can decide for each ballot if it's valid or not.
\begin{verbatim}
...
As we stated in introductory section that the formalization is carried out by 
axiomatising the cryptographic primitives. These cryptographic primitives are modelled 
as axiom. These axioms are related to  
